...
"[project]/app/api/v1/movies/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const GET = async (req)=>{
    ...
    try {
        ...
        const movies = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].collection("movies_n").find({}).sort({
            metacritic: -1
        }).limit(10).toArray();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__80cae1._.js.map