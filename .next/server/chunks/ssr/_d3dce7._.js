...
"[project]/lib/apis/server.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const registerUser = async (formData)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("v1/register", {
            json: formData
        });
...
const getMovies = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("v1/movies", {
            caches: "no-store"
        });
        if (response.ok) {
            return response.json();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apis$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/apis/server.js [app-ssr] (ecmascript)");
"use client";
;
;
;
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (isValid) {
            const login = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apis$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])({
                email: email,
                password: password
            });
        }
...
//# sourceMappingURL=_d3dce7._.js.map